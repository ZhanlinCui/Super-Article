...
```bash
npx skills add <repo> --skill markdown2wechat
```
...
- 若后续要配合 `wechat-publish` 上传草稿箱，推荐先用本 skill 生成 HTML，再交给发布 skill 处理 CSS 变量、图片和列表兼容

## Output

- 输出 HTML 文件，例如 `article.super.html`
